...
public class MultiColumnListView extends PLA_ListView {
    ...
    //wheat's code
    private OnColumnWidthIsMeasureListener mListener=null;
    //
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //wheat's code
        if(mListener!=null)
        	mListener.onColumnWidthIsMeasure(columnWidth);
        //
    }
    ...
    //wheat's code
    public interface OnColumnWidthIsMeasureListener
    {
    	public void onColumnWidthIsMeasure(int mColumnWidth);
    }
    
    public void setOnColumnWidthIsMeasureListener(OnColumnWidthIsMeasureListener listener)
    {
